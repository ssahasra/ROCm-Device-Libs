...
static uint asm_lane_id()
{
    uint out_val;
    __asm__ volatile ("v_mbcnt_lo_u32_b32 %0, -1, 0\n"
 ...
 */
static ulong
pop_free_stack(__global buffer_t *buffer, uint me)
{
    ulong packet_ptr = 0;
    if (me == __builtin_amdgcn_readfirstlane(me)) {
 ...
 */
static void
push_ready_stack(__global buffer_t *buffer, ulong ptr, uint me)
{
    if (me == __builtin_amdgcn_readfirstlane(me)) {
 ...
 */
static void
return_free_packet(__global buffer_t *buffer, ulong ptr, uint me)
{
    if (me == __builtin_amdgcn_readfirstlane(me)) {
            ...
            uint me)
{
    ...
    __global ulong *ptr = payload->slots[asm_lane_id()];
    ptr[0] = arg0;
    ptr[1] = arg1;
    ptr[2] = arg2;
    ptr[3] = arg3;
                         ...
                         ulong arg6, ulong arg7)
{
    ...
    ulong packet_ptr = pop_free_stack(buffer, me);
    ...
    fill_packet(header, payload, service_id, arg0, arg1, arg2, arg3, arg4, arg5,
                arg6, arg7, me);
    push_ready_stack(buffer, packet_ptr, me);

    long2 retval = get_return_value(header, payload, me);
    return_free_packet(buffer, packet_ptr, me);
    return retval;
}
